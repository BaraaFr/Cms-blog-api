                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-3 offset-md-7">
                            <a href="{{route('posts.create')}}" class='btn btn-sm btn-outline-success'>Add Post</a>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class='row'>
                                        <div class="col-sm-4">
                                        <a href="{{route('posts.edit',$post->id)}}"  class="btn btn-sm btn-primary" style='width:59px;'>Edit</a>
